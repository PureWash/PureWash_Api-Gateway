...
var file_user_common_proto_rawDesc = []byte{
	...
	0x72, 0x63, 0x68, 0x42, 0x0f, 0x5a, 0x0d, 0x67, 0x65, 0x6e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f,
...
func file_user_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_user_common_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_user_common_proto_msgTypes[1].Exporter = func(v any, i int) any {
