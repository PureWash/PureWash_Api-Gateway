...
const (
	...
	OrderService_UpdateOrderStatus_FullMethodName    = "/carpet_wash_service.OrderService/UpdateOrderStatus"
)
...
type OrderServiceClient interface {
	...
	GetAllOrderForCurier(ctx context.Context, in *GetAllOrdersReq, opts ...grpc.CallOption) (*GetOrdersResp, error)
	GetAllOrder(ctx context.Context, in *GetListRequest, opts ...grpc.CallOption) (*GetOrdersResp, error)
	UpdateOrderStatus(ctx context.Context, in *StatusOrderReq, opts ...grpc.CallOption) (*PrimaryKey, error)
}
...
func (c *orderServiceClient) GetAllOrderForCurier(ctx context.Context, in *GetAllOrdersReq, opts ...grpc.CallOption) (*GetOrdersResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *orderServiceClient) GetAllOrder(ctx context.Context, in *GetListRequest, opts ...grpc.CallOption) (*GetOrdersResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetOrdersResp)
...
func (c *orderServiceClient) UpdateOrderStatus(ctx context.Context, in *StatusOrderReq, opts ...grpc.CallOption) (*PrimaryKey, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PrimaryKey)
...
type OrderServiceServer interface {
	...
	GetAllOrderForCurier(context.Context, *GetAllOrdersReq) (*GetOrdersResp, error)
	GetAllOrder(context.Context, *GetListRequest) (*GetOrdersResp, error)
	UpdateOrderStatus(context.Context, *StatusOrderReq) (*PrimaryKey, error)
...
func (UnimplementedOrderServiceServer) GetAllOrderForCurier(context.Context, *GetAllOrdersReq) (*GetOrdersResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllOrderForCurier not implemented")
}
func (UnimplementedOrderServiceServer) GetAllOrder(context.Context, *GetListRequest) (*GetOrdersResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllOrder not implemented")
}
func (UnimplementedOrderServiceServer) UpdateOrderStatus(context.Context, *StatusOrderReq) (*PrimaryKey, error) {
...
func _OrderService_GetAllOrderForCurier_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetAllOrderForCurier(ctx, req.(*GetAllOrdersReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OrderService_UpdateOrderStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).UpdateOrderStatus(ctx, req.(*StatusOrderReq))
	}
	return interceptor(ctx, in, info, handler)
}
