    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.AddressForUserRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/user_order": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "User_Order  Request",
                        "name": "order",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.OrderForUserRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/user_order_canceled/{id}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Order Id canceled Request",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
